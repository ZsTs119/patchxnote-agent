...
| 包状态 | 公开 beta 版 `0.2.0`，默认连接 PatchXNote 公测 API。 |
...
> `0.2.0` 是公测 beta 构建。默认服务端是 PatchXNote 公测 API，凭据默认写入系统原生安全钥匙串。
...
发布二进制应报告版本 `0.2.0`，commit 应为 GitHub Release `v0.2.0` 对应的提交。
